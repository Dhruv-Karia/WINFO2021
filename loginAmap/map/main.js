...
var loc =
  ...
  var loc2 =
...

    {
      "type": "Feature",
      "properties": {
        "Underdog": "REBEL REBEL HAIR STUDIO",
        "Appearal": "",
        "Clothing and Appearal": "",
        "website": "",
        "": "",
    ...
    },
    {
      "type": "Feature",
      "properties": {
        "Underdog": "HEARTBEET ORGANIC SUPERFOODS CAFE – WEST SEATTLE",
        "Appearal": "",
        "Clothing and Appearal": "",
        "website": "",
        "": "",
...
loc2.features.forEach(function(lgbtqmarker) {
  var el = document.createElement('div');
  el.className = 'lgbtqmarker';
  new mapboxgl.Marker(el, { offset: [0, -23] })
      .setLngLat(lgbtqmarker.geometry.coordinates)
      .addTo(map);
  el.addEventListener('click', function(e) {
    var activeItem = document.getElementsByClassName('active');
    flyToStore(lgbtqmarker);
    createPopUp(lgbtqmarker);
    e.stopPropagation();
    if (activeItem[0]) {
      activeItem[0].classList.remove('active');
    }
